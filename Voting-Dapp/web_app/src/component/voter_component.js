            ...
            totalCandidate.map((candidate)=>{
              return(
                <Card sx={{ maxWidth: 380, float: "left", marginLeft: 8, marginBottom: 8 }}>
                  ...
                  <CardActions>
                    <Button variant="contained" onClick={(e)=>vote(candidate)}>Yes</Button>
                    <Button variant="contained" onClick={(e)=>vote(candidate)}>No</Button>
                    <Button variant="contained" onClick={(e)=>vote(candidate)}>Maybe</Button>
                  </CardActions>
                </Card>
              )
            })
